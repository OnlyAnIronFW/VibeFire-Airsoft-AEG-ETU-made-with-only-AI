...
1. **YOLO 人物检测** — YOLOv5n 模型在 RK3566 NPU 上运行，在 640x640 画面中实时检测人物，目标 30 FPS。
   
   > ⚠️ **v1.0 状态**: YOLO 使用 YOLOMock 进行开发验证，真实 RKNN 推理待 v1.1 实现。
...
| 弹道计算范围 | 0-80 m |
| 检测帧率 | 30 FPS (目标) |
| 端到端延迟 | ~130-150 ms (管线 ~38ms + 3帧共识 ~99ms) |
| 系统功耗 | ~5 W |
| 续航时间 | ~10 小时（10000 mAh 充电宝） |
| YOLO 推理 | v1.0 Mock，v1.1 RKNN 计划中 |
| 整机重量 | ~180 g |
| 总成本（BOM） | ¥755-785 |
